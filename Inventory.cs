...
public class OOP
{
    ...
    public void JsonDeserilaize()
    {
        ...
        InventoryUtility utility = JsonConvert.DeserializeObject<InventoryManager>(File.ReadAllText(@"G:\net\InventoryManagementProgram\InventoryManagementProgram\json.json"));
        // options
            ...
            case 2:
                ...
                switch (optionOne)
                {
                    case 1:
                        ...
                        File.WriteAllText(@"G:\net\InventoryManagementProgram\InventoryManagementProgram\json.json", JsonConvert.SerializeObject(utility));
                        break;
                    case 2:
                        // add records to inventory
